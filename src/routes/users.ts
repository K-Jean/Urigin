...
// Table d'assos
router.post('/:id/relations/',common.isAuthenticate(),common.checkId('id',models.users),common.postUserAssos(models.relations,'addOther','userId'));
router.post('/:id/games/',common.isAuthenticate(),common.checkId('id',models.users),common.postUserAssos(models.games,'addGame','gameId'));
